        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo ">
                <h2 class="text-center m-3 pt-2 bold">Z</h2>
            </div>
        </div>
        <!--**********************************
            Nav header end
        ...
        <div class="header">    
            <div class="header-content clearfix">
                ...
                <div class="header-left">
                    <h2 class="pmx-auto p-3 relative">Dashboard {{ Auth::user()->role }}</h2>
                </div>
                            ...
                            @auth
                                <li class="has-arrow">
                                    <a class="nav-link" href="{{ route('users.index') }}" aria-expanded="false">
                                        <i class="uil uil-users-alt"></i><span class="nav-text">Kelola Data Users</span>
                                    </a>
                                </li>
                            @endauth
                            @auth
                                <li class="has-arrow">
                                    <a class="nav-link" href="{{ route('menus.index') }}" aria-expanded="false">
                                        <i class="uil uil-crockery"></i><span class="nav-text">Daftar Menu</span>
                                    </a>
                                </li>
                            @endauth
                            @auth
                                <li class="has-arrow">
                                    <a class="nav-link" href="{{ route('transaksis.index') }}" aria-expanded="false">
                                        <i class="uil uil-transaction"></i><span class="nav-text">Daftar Transaksi</span>
                                    </a>
                                </li>
                            @endauth
                            @auth
